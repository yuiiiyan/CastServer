package com.sixin.plugin;

import com.sixin.entity.Page;
import com.sixin.util.ReflectHelper;
		...
		if(ivk.getTarget() instanceof RoutingStatementHandler){
			...
			if(mappedStatement.getId().matches(pageSqlId)){ //拦截�?要分页的SQL
				...
				if(parameterObject==null){
					...
					String fhsql = sql;
					String countSql = "select count(0) from (" + fhsql+ ")  tmp_count"; //记录统计 == oracle �? as 报错(SQL command not properly ended)
