...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['src/WebContent/WEB-INF/static/ace/js/date-time/moment', 'jquery', 'exports'], function(momentjs, $, exports) {
      root.daterangepicker = factory(root, exports, momentjs, $);
    });

  } else if (typeof exports !== 'undefined') {
    var momentjs = require('src/WebContent/WEB-INF/static/ace/js/date-time/moment');
    var jQuery;
    try {
