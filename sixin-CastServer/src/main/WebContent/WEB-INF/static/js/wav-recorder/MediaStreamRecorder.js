...
function StereoAudioRecorderHelper(mediaStream, root) {
    ...
    // variables    
    var deviceSampleRate = 22050; // range: 22050 to 96000  11025  8000Hz 
...
//        if(isFirst){//wav文件开头
	        ...
	        view.setUint32(28, sampleRate * numChannels * (sampleBits/8), true); // numChannels * 2 (via #71)
	        ...
	        isFirst = false;
//        }else{
//        	var buffer = new ArrayBuffer(8 + interleaved.length * 2);
//	        var view = new DataView(buffer);
//	
//	        // data sub-chunk
//	        writeUTFBytes(view, 0, 'data');
//	        view.setUint32(4, interleaved.length * 2, true);
//	
//	        // write the PCM samples
//	        var lng = interleaved.length;
//	        var index = 8;
